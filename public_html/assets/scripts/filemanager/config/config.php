...
$config = array(
    ...
    */
    ...
    |
    */
    'thumbs_base_path' => $fileDir.'../thumbs/',
    ...
    */
    ...
    'upload_files'                            => true,
    'rename_files'                            => true,
    'rename_folders'                          => ($_SESSION['tmc_game_dir_access'] === true ? true : false),
...
$upload_dir = $baseDir; // path from base_url to base of upload folder (with start and final /)
$current_path = $fileDir; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = $fileDir.'../thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
...
$default_language 	= "pl"; //default language file name
...
$show_sorting_bar	= FALSE; //Show or not show sorting feature in filemanager
...
//******************
$delete_files		= TRUE;
$create_folders		= ($_SESSION['tmc_game_dir_access'] === true ? true : false);
$delete_folders		= ($_SESSION['tmc_game_dir_access'] === true ? true : false);
$upload_files		= TRUE;
$rename_files		= TRUE;
$rename_folders		= ($_SESSION['tmc_game_dir_access'] === true ? true : false);
$duplicate_files	= FALSE;
...
// you can create these type of files if $create_text_files is true (only text based files)
// if you want you can add html,css etc. 
// but for security reasons it's NOT RECOMMENDED! 'txt', 'log', 'xml','html','css','htm','js'
...
//**********************
$ext_img 	= array('jpg', 'jpeg', 'png', 'gif', 'bmp', 'tiff', 'svg'); //Images
$ext_file 	= array(); //Files 'doc', 'docx','rtf', 'pdf', 'xls', 'xlsx', 'txt', 'csv','html','xhtml','psd','sql','log','fla','xml','ade','adp','mdb','accdb','ppt','pptx','odt','ots','ott','odb','odg','otp','otg','odf','ods','odp','css','ai'
$ext_video 	= array(); //Video  'mov', 'mpeg', 'm4v', 'mp4', 'avi', 'mpg','wma',"flv","webm"
$ext_music 	= array(); //Audio 'mp3', 'm4a', 'ac3', 'aiff', 'mid','ogg','wav'
$ext_misc 	= array(); //Archives 'zip', 'rar','gz','tar','iso','dmg'
