        ...
        <div>
            {% for msg in page.items %}
                <div style="float: left; width: 100%; margin: 5px 0px; border-bottom: 1px dotted rgb(51, 102, 0); padding-bottom: 5px; position: relative;">
                    ...
                    <div style="font-family: Pixel; font-size: 16px; color: #e7cf9f; float: left; padding: 5px 0px; width: 400px; overflow: hidden; text-align: left;">
                        {{ msg.topic }}
                    </div>
