...
{% block content %}
    <div class="module_content message_content">
        ...
        <div class="text" style="border-bottom: 1px dotted ;">{{ msgtext }}</div>
        ...
        <div id="conversation_history">
            <div style="float: left; width: 100%; font-family: Pixel; border-top: 1px solid; border-bottom: 1px solid; padding: 10px 0px; text-align: center; margin-top: 20px;">{{ t['messages-topic_history'] }}</div>
            {% for conversation in page.items %}
                ...
                <div style="float: left; width: 100%; margin: 5px 0px; padding-bottom: 5px; position: relative;" id="msg_conv_{{ conversation.Messages.id }}">
                    ...
                    <div class="text">
                        {% autoescape false %}
                            {{ conversation.MyMessageText.text }}
                        {% endautoescape %}
